...
type incomingUniStreamsMap struct {
	...
	newStream        func(protocol.StreamNum, bool) receiveStreamI
...
func (m *incomingUniStreamsMap) GetOrOpenStream(num protocol.StreamNum, unreliable bool) (receiveStreamI, error) {
	m.mutex.RLock()
	if num > m.maxStream {
		m.mutex.RUnlock()
